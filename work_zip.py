...
a = '2020'
b = 'For all directory paths required, insert the ' + Color.BOLD + Color.GREEN + 'ABSOLUTE PATH' + Color.END + ' and ' + Color.BOLD + Color.UNDERLINE + Color.RED + 'NOT' + Color.END + ' the relative path.' 
c = 'Example:' 
...
print(b)
print(Color.UNDERLINE + Color.RED + c + Color.END)
print(Color.BLUE + d + a+  Color.END)
print(Color.MAGENTA + e + a + Color.END)
